		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "逆ザヤ防止分析",
									"targetURL": "#bicostanalysis-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bicostanalysis-display": {
								"semanticObject": "bicostanalysis",
								"action": "display",
								"description": "逆ザヤ防止分析",
								"title": "逆ザヤ防止分析",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bi.costanalysis",
									"url": sap.ui.require.toUrl("bi/costanalysis")
								}
							}
						}
					}
