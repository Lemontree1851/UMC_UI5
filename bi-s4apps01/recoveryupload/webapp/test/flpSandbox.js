		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "回収残データ一括アップロード",
									"targetURL": "#birecoveryupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"birecoveryupload-display": {
								"semanticObject": "birecoveryupload",
								"action": "display",
								"description": "回収残データ一括アップロード",
								"title": "回収残データ一括アップロード",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bi.recoveryupload",
									"url": sap.ui.require.toUrl("bi/recoveryupload")
								}
							}
						}
					}
