		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "部品使用先一覧レポート",
									"targetURL": "#ppzcomponentusagelist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ppzcomponentusagelist-display": {
								"semanticObject": "ppzcomponentusagelist",
								"action": "display",
								"description": "部品使用先一覧レポート",
								"title": "部品使用先一覧レポート",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pp.zcomponentusagelist",
									"url": sap.ui.require.toUrl("pp/zcomponentusagelist")
								}
							}
						}
					}
