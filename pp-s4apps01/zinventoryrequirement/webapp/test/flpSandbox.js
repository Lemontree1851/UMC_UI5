		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Inventory Requirement Report",
									"targetURL": "#ppzinventoryrequirement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ppzinventoryrequirement-display": {
								"semanticObject": "ppzinventoryrequirement",
								"action": "display",
								"description": "Inventory Requirement Report",
								"title": "Inventory Requirement Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pp.zinventoryrequirement",
									"url": sap.ui.require.toUrl("pp/zinventoryrequirement")
								}
							}
						}
					}
