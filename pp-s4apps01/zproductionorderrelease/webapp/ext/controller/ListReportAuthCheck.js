    ...
    return {
        ...
        _getAuthorityData: function (oAuthorityModel, oLocalModel, oI18nModel) {
            ...
            oContextBinding.requestObject().then(function (context) {
                ...
                if (!aAllAccessBtns.some(btn => btn.AccessId === "zproductionorderrelease-View")) {
                ...
                oLocalModel.setProperty("/authorityCheck", {
                    button: {
                        View: aAllAccessBtns.some(btn => btn.AccessId === "zproductionorderrelease-View"),
                        Release: aAllAccessBtns.some(btn => btn.AccessId === "zproductionorderrelease-Release")
                    },
                    data: { 
