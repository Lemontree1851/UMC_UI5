sap.ui.define([
    ...
    var iExcuteTimes = 1;
    return ControllerExtension.extend("pp.zledplannedordercomponent.ext.controller.ListReport", {

        override: {
            onPendingFilters: function () {
                var oFilterBar = this.getView().byId("pp.zledplannedordercomponent::ZR_LEDPLANNEDORDERCOMPONENTList--fe::FilterBar::ZR_LEDPLANNEDORDERCOMPONENT");
        ...
        onFilterSearch: function (oEvent) {
            var bHasError = false;
            var oTable = this.getView().byId("pp.zledplannedordercomponent::ZR_LEDPLANNEDORDERCOMPONENTList--fe::table::ZR_LEDPLANNEDORDERCOMPONENT::LineItem-innerTable");
