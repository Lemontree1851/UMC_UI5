		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OFとSO比較照会",
									"targetURL": "#ppofsocomparison-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ppofsocomparison-display": {
								"semanticObject": "ppofsocomparison",
								"action": "display",
								"description": "OFとSO比較照会",
								"title": "OFとSO比較照会",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pp.ofsocomparison",
									"url": sap.ui.require.toUrl("pp/ofsocomparison")
								}
							}
						}
					}
