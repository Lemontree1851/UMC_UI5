		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ppzorderforecastupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ppzorderforecastupload-display": {
								"semanticObject": "ppzorderforecastupload",
								"action": "display",
								"description": "Mass Upload Order Forecast",
								"title": "Mass Upload Order Forecast",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pp.zorderforecastupload",
									"url": sap.ui.require.toUrl("pp/zorderforecastupload")
								}
							}
						}
					}
