		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage Picking List",
									"targetURL": "#ppzpickinglist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ppzpickinglist-display": {
								"semanticObject": "ppzpickinglist",
								"action": "display",
								"description": "Manage Picking List",
								"title": "Manage Picking List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pp.zpickinglist",
									"url": sap.ui.require.toUrl("pp/zpickinglist")
								}
							}
						}
					}
