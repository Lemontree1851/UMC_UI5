		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "作業手順一括登録",
									"targetURL": "#ppzroutingupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ppzroutingupload-display": {
								"semanticObject": "ppzroutingupload",
								"action": "display",
								"description": "作業手順一括登録",
								"title": "作業手順一括登録",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pp.zroutingupload",
									"url": sap.ui.require.toUrl("pp/zroutingupload")
								}
							}
						}
					}
