		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "製造バージョン一括登録",
									"targetURL": "#ppzproductionversionupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ppzproductionversionupload-display": {
								"semanticObject": "ppzproductionversionupload",
								"action": "display",
								"description": "製造バージョン一括登録",
								"title": "製造バージョン一括登録",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pp.zproductionversionupload",
									"url": sap.ui.require.toUrl("pp/zproductionversionupload")
								}
							}
						}
					}
