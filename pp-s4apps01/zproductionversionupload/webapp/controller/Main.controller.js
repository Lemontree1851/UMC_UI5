            ...
            oReader.onload = function (e) {
                ...
                for (var i = 5; i < aSheetData.length; i++) {
                    var item = {
                        ...
                        "ExecBillOfOperationsType": aSheetData[i]["ExecBillOfOperationsType"] === undefined ? "" : aSheetData[i]["ExecBillOfOperationsType"],
                        "ExecBillOfOperationsGroup": aSheetData[i]["ExecBillOfOperationsGroup"] === undefined ? "" : aSheetData[i]["ExecBillOfOperationsGroup"],
                        "ExecBillOfOperationsVariant": aSheetData[i]["ExecBillOfOperationsVariant"] === undefined ? "" : aSheetData[i]["ExecBillOfOperationsVariant"],
