            ...
            oReader.onload = function (e) {
                ...
                for (var i = 5; i < aSheetData.length; i++) {
                    var item = {
                        ...
                        "BillOfOperationsType": aSheetData[i]["BillOfOperationsType"],
                        "BillOfOperationsGroup": aSheetData[i]["BillOfOperationsGroup"],
                        "BillOfOperationsVariant": aSheetData[i]["BillOfOperationsVariant"],
