		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ppproductionplan-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ppproductionplan-display": {
								"semanticObject": "ppproductionplan",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pp.productionplan",
									"url": sap.ui.require.toUrl("pp/productionplan")
								}
							}
						}
					}
