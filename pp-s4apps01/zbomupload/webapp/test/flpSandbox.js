		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mass Upload BOM",
									"targetURL": "#ppzbomupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ppzbomupload-display": {
								"semanticObject": "ppzbomupload",
								"action": "display",
								"description": "Mass Upload BOM",
								"title": "Mass Upload BOM",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pp.zbomupload",
									"url": sap.ui.require.toUrl("pp/zbomupload")
								}
							}
						}
					}
