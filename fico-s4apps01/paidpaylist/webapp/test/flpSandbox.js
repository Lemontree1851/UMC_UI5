		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PaidPay List",
									"targetURL": "#ficopaidpaylist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ficopaidpaylist-display": {
								"semanticObject": "ficopaidpaylist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fico.paidpaylist",
									"url": sap.ui.require.toUrl("fico/paidpaylist")
								}
							}
						}
					}
