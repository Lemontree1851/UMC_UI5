		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PaidPay Calculation",
									"targetURL": "#ficopaidpaycalculation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ficopaidpaycalculation-display": {
								"semanticObject": "ficopaidpaycalculation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fico.paidpaycalculation",
									"url": sap.ui.require.toUrl("fico/paidpaycalculation")
								}
							}
						}
					}
