		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Agent Purchase Journal Entry Generation",
									"targetURL": "#ficozagencypurchasingnew-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ficozagencypurchasingnew-display": {
								"semanticObject": "ficozagencypurchasingnew",
								"action": "display",
								"description": "Agent Purchase Journal Entry Generation",
								"title": "Agent Purchase Journal Entry Generation",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fico.zagencypurchasingnew",
									"url": sap.ui.require.toUrl("fico/zagencypurchasingnew")
								}
							}
						}
					}
