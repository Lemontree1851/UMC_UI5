    ...
    return {
        ...
        _getAuthorityData: function (oAuthorityModel, oLocalModel, oI18nModel) {
            ...
            oContextBinding.requestObject().then(function (context) {
                ...
                if (!aAllAccessBtns.some(btn => btn.AccessId === "zbindglupload-View")) {
                ...
                oLocalModel.setProperty("/authorityCheck", {
                    button: {
                        View: aAllAccessBtns.some(btn => btn.AccessId === "zbindglupload-View"),
                        Upload: aAllAccessBtns.some(btn => btn.AccessId === "zbindglupload-Upload"),
                        Clear: aAllAccessBtns.some(btn => btn.AccessId === "zbindglupload-Clear"),
                        Check: aAllAccessBtns.some(btn => btn.AccessId === "zbindglupload-Check"),
                        Excute: aAllAccessBtns.some(btn => btn.AccessId === "zbindglupload-Excute"),
                        Export: aAllAccessBtns.some(btn => btn.AccessId === "zbindglupload-Export"),
                        Edit: aAllAccessBtns.some(btn => btn.AccessId === "zbindglupload-Edit"),
                        Delete: aAllAccessBtns.some(btn => btn.AccessId === "zbindglupload-Delete") 
                    },
                    data: {
