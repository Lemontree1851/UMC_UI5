		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Inventoy Aging Upload",
									"targetURL": "#ficozinageupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ficozinageupload-display": {
								"semanticObject": "ficozinageupload",
								"action": "display",
								"description": "Inventoy Aging Upload",
								"title": "Inventoy Aging Upload",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fico.zinageupload",
									"url": sap.ui.require.toUrl("fico/zinageupload")
								}
							}
						}
					}
