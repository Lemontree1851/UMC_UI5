		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PaidPay Document",
									"targetURL": "#ficopaidpaydocument-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ficopaidpaydocument-display": {
								"semanticObject": "ficopaidpaydocument",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fico.paidpaydocument",
									"url": sap.ui.require.toUrl("fico/paidpaydocument")
								}
							}
						}
					}
