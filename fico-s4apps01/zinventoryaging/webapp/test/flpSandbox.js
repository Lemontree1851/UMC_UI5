		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "長期滞在＆低価法レポート",
									"targetURL": "#ficozinventoryaging-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ficozinventoryaging-display": {
								"semanticObject": "ficozinventoryaging",
								"action": "display",
								"description": "長期滞在＆低価法レポート",
								"title": "長期滞在＆低価法レポート",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fico.zinventoryaging",
									"url": sap.ui.require.toUrl("fico/zinventoryaging")
								}
							}
						}
					}
