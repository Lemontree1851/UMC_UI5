sap.ui.define([
    ...
    return {
        ...
        openUploadDialog: function () {
            var that = this;
            this._Function = sap.ui.require("fico/zstockageupload/ext/controller/ListReportExt");
            this._BusyDialog = new BusyDialog();
            this._BusyDialog.open();
            Fragment.load({
                name: "fico.zstockageupload.ext.fragments.Upload",
                controller: this
        ...
        _callODataAction: function (bEvent, aRequestData, that) {
            return new Promise((resolve, reject) => {
                var uploadProcess = that.getModel().bindContext("/STOCKAGEUPLOAD/com.sap.gateway.srvd.zui_stockageupload.v0001.processLogic(...)");
