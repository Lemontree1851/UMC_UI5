			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ficopaidpay-display": {
								"semanticObject": "ficopaidpay",
								"action": "display",
								"description": "PaidPay Calculation",
								"title": "PaidPay Calculation",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fico.paidpay",
									"url": sap.ui.require.toUrl("fico/paidpay")
								}
							}
						}
					}
