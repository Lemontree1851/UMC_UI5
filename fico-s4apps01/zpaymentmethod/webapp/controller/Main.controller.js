    ...
    return Base.extend("fico.zpaymentmethod.controller.Main", {
        ...
        _initialize: function () {
            ...
            oContextBinding.requestObject().then(function (context) {
                ...
                if (!aAllAccessBtns.some(btn => btn.AccessId === "zpaymentmethod-View")) {
                ...
                this.getOwnerComponent().getModel("local").setProperty("/authorityCheck", {
                    button: {
                        View: aAllAccessBtns.some(btn => btn.AccessId === "zpaymentmethod-View"),
                        TestExcute: aAllAccessBtns.some(btn => btn.AccessId === "zpaymentmethod-TestExcute"),
                        Excute: aAllAccessBtns.some(btn => btn.AccessId === "zpaymentmethod-Excute"),
                        ExcuteWithJob: aAllAccessBtns.some(btn => btn.AccessId === "zpaymentmethod-ExcuteWithJob"),
                        Export: aAllAccessBtns.some(btn => btn.AccessId === "zpaymentmethod-Export")
                    },
                    data: {
