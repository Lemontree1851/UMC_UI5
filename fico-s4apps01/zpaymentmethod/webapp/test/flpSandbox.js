		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "支払方法変更",
									"targetURL": "#ficozpaymentmethod-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ficozpaymentmethod-display": {
								"semanticObject": "ficozpaymentmethod",
								"action": "display",
								"description": "支払方法変更",
								"title": "支払方法変更",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fico.zpaymentmethod",
									"url": sap.ui.require.toUrl("fico/zpaymentmethod")
								}
							}
						}
					}
