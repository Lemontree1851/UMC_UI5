		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ficozbdglupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ficozbdglupload-display": {
								"semanticObject": "ficozbdglupload",
								"action": "display",
								"description": "Binding GLAccount Upload",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fico.zbdglupload",
									"url": sap.ui.require.toUrl("fico/zbdglupload")
								}
							}
						}
					}
