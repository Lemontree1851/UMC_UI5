    ...
    return {
        ...
        _getAuthorityData: function (oAuthorityModel, oLocalModel, oI18nModel) {
            ...
            oContextBinding.requestObject().then(function (context) {
                ...
                if (!aAllAccessBtns.some(btn => btn.AccessId === "fixedassetprint-View")) {
                ...
                oLocalModel.setProperty("/authorityCheck", {
                    button: {
                        View: aAllAccessBtns.some(btn => btn.AccessId === "fixedassetprint-View"),
                        Export: aAllAccessBtns.some(btn => btn.AccessId === "fixedassetprint-Export")
                    },
                    data: {
