		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#mmzpurchasepricevariance-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mmzpurchasepricevariance-display": {
								"semanticObject": "mmzpurchasepricevariance",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mm.zpurchasepricevariance",
									"url": sap.ui.require.toUrl("mm/zpurchasepricevariance")
								}
							}
						}
					}
