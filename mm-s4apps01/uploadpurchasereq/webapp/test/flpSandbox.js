		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "購買申請登録とファイル添付",
									"targetURL": "#mmuploadpurchasereq-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mmuploadpurchasereq-display": {
								"semanticObject": "mmuploadpurchasereq",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mm.uploadpurchasereq",
									"url": sap.ui.require.toUrl("mm/uploadpurchasereq")
								}
							}
						}
					}
