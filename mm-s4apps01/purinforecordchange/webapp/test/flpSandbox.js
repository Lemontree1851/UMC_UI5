		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#mmpurinforecordchange-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mmpurinforecordchange-display": {
								"semanticObject": "mmpurinforecordchange",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mm.purinforecordchange",
									"url": sap.ui.require.toUrl("mm/purinforecordchange")
								}
							}
						}
					}
