		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Physical Inventory Upload",
									"targetURL": "#mmphysicalinventoryupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mmphysicalinventoryupload-display": {
								"semanticObject": "mmphysicalinventoryupload",
								"action": "display",
								"description": "MM-013棚卸検数結果一括登録",
								"title": "Physical Inventory Upload",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mm.physicalinventoryupload",
									"url": sap.ui.require.toUrl("mm/physicalinventoryupload")
								}
							}
						}
					}
