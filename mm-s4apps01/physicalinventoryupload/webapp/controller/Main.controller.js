        ...
        return Base.extend("mm.physicalinventoryupload.controller.Main", {
            ...
            _initialize: function () {
                ...
                oContextBinding.requestObject().then(function (context) {
                    ...
                    if (!aAllAccessBtns.some(btn => btn.AccessId === "physicalinventoryupload-View")) {
                    ...
                    this.getModel("local").setProperty("/authorityCheck", {
                        button: {
                            View: aAllAccessBtns.some(btn => btn.AccessId === "physicalinventoryupload-View"),
                            Clear: aAllAccessBtns.some(btn => btn.AccessId === "physicalinventoryupload-Clear"),
                            Summary: aAllAccessBtns.some(btn => btn.AccessId === "physicalinventoryupload-Summary"),
                            Excute: aAllAccessBtns.some(btn => btn.AccessId === "physicalinventoryupload-Excute"),
                            Export: aAllAccessBtns.some(btn => btn.AccessId === "physicalinventoryupload-Export")
                        },
                        data: {
