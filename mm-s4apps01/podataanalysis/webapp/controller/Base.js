sap.ui.define([
    ...
    return Controller.extend("pp.zinventoryrequirement.controller.Base", {
        ...
        _CallODataV2: function (sModelName, sMethod, sPath, aFilters, mUrlParameter, oRequestData) {
            var that = this;
            var oModel;
            ...
            return new Promise(function (resolve, reject) {
                ...
                if (sModelName) {
                    oModel = that.getModel(sModelName);
                } else {
                ...
                switch (sMethod) {
                    case "READ":
                        ...
                        break;
                    case "CREATE":
                        oModel.create(sPath, oRequestData, mParameters);
                        break;
                    case "UPDATE":
                        oModel.update(sPath, oRequestData, mParameters);
                        break;
                    case "DELETE":
