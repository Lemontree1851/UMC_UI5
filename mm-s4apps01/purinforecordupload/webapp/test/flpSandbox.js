		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Purchasing Info Record Upload",
									"targetURL": "#mmpurinforecordupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mmpurinforecordupload-display": {
								"semanticObject": "mmpurinforecordupload",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mm.purinforecordupload",
									"url": sap.ui.require.toUrl("mm/purinforecordupload")
								}
							}
						}
					}
