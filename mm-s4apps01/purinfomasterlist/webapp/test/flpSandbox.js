		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pur Info Master List",
									"targetURL": "#mmpurinfomasterlist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mmpurinfomasterlist-display": {
								"semanticObject": "mmpurinfomasterlist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mm.purinfomasterlist",
									"url": sap.ui.require.toUrl("mm/purinfomasterlist")
								}
							}
						}
					}
