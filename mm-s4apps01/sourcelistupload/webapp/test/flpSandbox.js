		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Source List Upload",
									"targetURL": "#mmsourcelistupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mmsourcelistupload-display": {
								"semanticObject": "mmsourcelistupload",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mm.sourcelistupload",
									"url": sap.ui.require.toUrl("mm/sourcelistupload")
								}
							}
						}
					}
