		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "与信管理表",
									"targetURL": "#sdzcreditmantablenew-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sdzcreditmantablenew-display": {
								"semanticObject": "sdzcreditmantablenew",
								"action": "display",
								"description": "与信管理表",
								"title": "与信管理表",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sd.zcreditmantablenew",
									"url": sap.ui.require.toUrl("sd/zcreditmantablenew")
								}
							}
						}
					}
