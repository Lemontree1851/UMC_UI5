sap.ui.define([
    ...
    function (Base,
        ...
        */
        ...
        return Base.extend("sd.salesacceptdn.controller.Main", {
            formatter: formatter,
            onInit: function () {
            ...
            _initialize: function () {
                ...
                oContextBinding.requestObject().then(function (context) {
                    ...
                    if (!aAllAccessBtns.some(btn => btn.AccessId === "salesacceptdn-View")) {
                    ...
                    this.getModel("local").setProperty("/authorityCheck", {
                        button: {
                            View: aAllAccessBtns.some(btn => btn.AccessId === "salesacceptdn-View"),
                        },
                        data: {
