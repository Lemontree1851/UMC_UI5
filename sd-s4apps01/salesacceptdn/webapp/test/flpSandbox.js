		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TWX21検収データ取込み機能",
									"targetURL": "#sdsalesacceptdn-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sdsalesacceptdn-display": {
								"semanticObject": "sdsalesacceptdn",
								"action": "display",
								"description": "TWX21検収データ取込み機能",
								"title": "TWX21検収データ取込み機能",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sd.salesacceptdn",
									"url": sap.ui.require.toUrl("sd/salesacceptdn")
								}
							}
						}
					}
