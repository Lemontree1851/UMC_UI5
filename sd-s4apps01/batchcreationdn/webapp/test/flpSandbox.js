		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "出荷伝票一括登録",
									"targetURL": "#sdbatchcreationdn-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sdbatchcreationdn-display": {
								"semanticObject": "sdbatchcreationdn",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sd.batchcreationdn",
									"url": sap.ui.require.toUrl("sd/batchcreationdn")
								}
							}
						}
					}
