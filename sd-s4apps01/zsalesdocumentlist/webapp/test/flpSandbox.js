		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "受注管理レポート",
									"targetURL": "#sdzsalesdocumentlist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sdzsalesdocumentlist-display": {
								"semanticObject": "sdzsalesdocumentlist",
								"action": "display",
								"description": "受注管理レポート",
								"title": "受注管理レポート",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sd.zsalesdocumentlist",
									"url": sap.ui.require.toUrl("sd/zsalesdocumentlist")
								}
							}
						}
					}
