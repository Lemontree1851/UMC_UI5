		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "販売計画一覧",
									"targetURL": "#sdsalesdocumentreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sdsalesdocumentreport-display": {
								"semanticObject": "sdsalesdocumentreport",
								"action": "display",
								"description": "販売計画一覧",
								"title": "販売計画一覧",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sd.salesdocumentreport",
									"url": sap.ui.require.toUrl("sd/salesdocumentreport")
								}
							}
						}
					}
