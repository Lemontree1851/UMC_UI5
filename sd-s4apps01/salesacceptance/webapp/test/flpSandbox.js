		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sdsalesacceptance-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sdsalesacceptance-display": {
								"semanticObject": "sdsalesacceptance",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sd.salesacceptance",
									"url": sap.ui.require.toUrl("sd/salesacceptance")
								}
							}
						}
					}
