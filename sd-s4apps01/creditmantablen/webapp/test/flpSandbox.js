		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "与信管理表",
									"targetURL": "#sdcreditmantablen-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sdcreditmantablen-display": {
								"semanticObject": "sdcreditmantablen",
								"action": "display",
								"description": "与信管理表",
								"title": "与信管理表",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sd.creditmantablen",
									"url": sap.ui.require.toUrl("sd/creditmantablen")
								}
							}
						}
					}
