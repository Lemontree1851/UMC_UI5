		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "与信管理表",
									"targetURL": "#sdcreditmantable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sdcreditmantable-display": {
								"semanticObject": "sdcreditmantable",
								"action": "display",
								"description": "与信管理表",
								"title": "与信管理表",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sd.creditmantable",
									"url": sap.ui.require.toUrl("sd/creditmantable")
								}
							}
						}
					}
