		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Salesaccept Result",
									"targetURL": "#sdsalesacceptresult-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sdsalesacceptresult-display": {
								"semanticObject": "sdsalesacceptresult",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sd.salesacceptresult",
									"url": sap.ui.require.toUrl("sd/salesacceptresult")
								}
							}
						}
					}
