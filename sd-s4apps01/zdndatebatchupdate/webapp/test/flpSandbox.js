		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "出荷伝票外部移転の日付一括更新",
									"targetURL": "#sdzdndatebatchupdate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sdzdndatebatchupdate-display": {
								"semanticObject": "sdzdndatebatchupdate",
								"action": "display",
								"description": "出荷伝票外部移転の日付一括更新",
								"title": "出荷伝票外部移転の日付一括更新",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sd.zdndatebatchupdate",
									"url": sap.ui.require.toUrl("sd/zdndatebatchupdate")
								}
							}
						}
					}
